...
tables_cost_0 = table_quantity_0 * table_price_0

table_item_1 = store[table_code][1]
table_quantity_1 = table_item_1['quantity']
table_price_1 = table_item_1['price']
tables_cost_1 = table_quantity_1 * table_price_1

tables_cost = tables_cost_1 + tables_cost_0
table_quantity = table_quantity_1 + table_quantity_0
...
sofa_cost = sofa_cost_1 + sofa_cost_0
sofa_quantity = sofa_quantity_1 + sofa_quantity_0
...
chair_cost = chair_cost_1 + chair_cost_0 + chair_cost_2
chair_quantity = chair_quantity_1 + chair_quantity_0 + chair_quantity_2
